...
codesign --verbose=2 --deep --force --identifier "com.bohemiancoding.sketchtool" $OTHER_CODE_SIGN_FLAGS --sign "Developer ID Application: Bohemian Coding" "${CODESIGNING_FOLDER_PATH}/Contents/MacOS/sketchtool" 
